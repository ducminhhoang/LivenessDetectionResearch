...
class CASIA_Dataset(BaseDataset):
    def __init__(self, cfg):
        super(CASIA_Dataset, self).__init__(cfg)
        ...
        for file_name in self.zip_file.namelist():
            if 'color' in file_name and file_name.endswith((".jpg", ".png", ".jpeg")):
        ...
        self.train_image_labels = self._get_image_labels(r"train_img/train_img/color")
        self.valid_image_labels = self._get_image_labels(r"test_img/test_img/color")
    ...
    def normalize(self, image_name, label=None):
